    ...
    */
    ...
    Contour.prototype = _.extend(Contour.prototype, {
        ...
        calculateWidth: function () {
            ...
            var outerWidth = parseInt(NwUtils.getStyle(this.options.el, 'width') || 0, 10);
            var paddingLeft = parseInt(NwUtils.getStyle(this.options.el, 'padding-left') || 0, 10);
            var paddingRight = parseInt(NwUtils.getStyle(this.options.el, 'padding-right') || 0, 10);
        ...
        calculateHeight: function () {
            // assume all in pixel units and border-box box-sizing
            var outerHeight = parseInt(NwUtils.getStyle(this.options.el, 'height') || 0, 10);
            var paddingTop = parseInt(NwUtils.getStyle(this.options.el, 'padding-top') || 0, 10);
            var paddingBottom = parseInt(NwUtils.getStyle(this.options.el, 'padding-bottom') || 0, 10);
        ...
        */
        ...
        dataNormalizer: NwUtils.normalizeSeries,

        isSupportedDataFormat: NwUtils.isSupportedDataFormat
    });
