    ...
    */
    ...
    OrdinalScale.prototype = {
        ...
        axis: function () {
            ...
            var labelsFit = NwUtils.doXLabelsFit(ticks, formatLabel, this.options);
            ...
            if (options.firstAndLast) {
                ...
                var finalTicks = NwUtils.getTicksThatFit(ticks, formatLabel, this.options);
        ...
        rangeBand: function () {
            ...
            if (!band) NwUtils.warn('rangeBand is 0, you may have too many points in in the domain for the size of the chart (ie. chartWidth = ' + this.options.chart.plotWidth + 'px and ' + (this._domain.length) + ' X-axis points (plus paddings) means less than 1 pixel per band and there\'re no half pixels');
    ...
    NwUtils.addAxis('OrdinalScale', OrdinalScale );
