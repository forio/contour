(function () {
    ...
    function Legend(data, layer, options) {
        ...
        var em = NwUtils.textBounds('series', '.contour-legend.contour-legend-entry');
        ...
        container.attr('style', function () {
            ...
            if (options.legend.hAlign === 'left') {
                ...
                var bounds = NwUtils.textBounds(this, '.contour-legend');
        ...
        entries.append('span')
            .attr('class', function (d, i) { return 'contour-legend-key series s-' + (i+1) + ' ' + NwUtils.seriesNameToClass(d.name); });
